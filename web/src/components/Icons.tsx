...
export function MusicIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M9 9.5V16M9 9.5c0-1.5 2-2 3-2s3 .5 3 2-2 2-3 2-3 .5-3 2 2 2 3 2 3-.5 3-2" />
    </svg>
  );
}
...
export function DeviceIcon({ type, className }: IconProps & { type: string }) {
  if (type === "earbuds") {
    return (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M6 8a6 6 0 0112 0v4a2 2 0 01-2 2h-1" />
        <path d="M6 12v2a2 2 0 002 2h1" />
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M3 14v-4a2 2 0 012-2h2l4-4v16l-4-4H5a2 2 0 01-2-2z" />
